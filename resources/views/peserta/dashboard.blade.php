...
<body>
    <div id="container">
        ...
        <header>
            ...
            <div class="header-right">
                ...
                <span class="h4 fw-bold mr-4 text-dark p-2" style="border-radius: 20px"><a
                        href="{{ route('logout') }}"
        ...
        <div id="content">
            ...
            <div class="content-top">
                ...
                <section class="gift ps-4 pe-4">
                    ...
                    <button class="btn btn-primary w-100 mt-2" id="btn-gift" data-bs-toggle="modal"
                        data-bs-target="#konfirmasi-gift">Gift</button>

                    {{-- [KENNETH] Pengecekan untuk button Buy Material --}}
                    <button class="btn btn-primary w-100 mt-4" id="btn-buy-material"
                    ...
                    <table class="history-table">
                        <tbody id="histories-list">
                            @foreach ($histories as $h)
                                <tr>
                                    <td>
                                        <div class="history-detail"><b>[{{ $h->type }}]</b> {{ $h->name }}
                                            &nbsp;&nbsp;<span style="font-size: 100%"
                                                class="fw-bold fst-italic">{{ $h->time }}</span></div>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                        ...
                        <tbody>
                            @foreach ($equipments as $e)
                                <tr>
                                    ...
                                    <td id="jumlah-equipment-{{ $e->id_equipment }}">{{ $e->jumlah_equipment }}
                                    </td>
                                    <td><button type="button" class="btn btn-info btn-craft text-white p-1"
                                            value="{{ $e->id_equipment }}"
                                            style="width: 80%; padding: 2%">Crafting</button></td>
                                    <td><button type="button" class="btn btn-primary btn-use p-1"
                                            value="{{ $e->id_equipment }}"
                                            style="width: 80%; padding: 2%">Use</button></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                ...
                <section class="control">
                    ...
                    <div class="attack">
                        @if ($team->weapon_level == 0)
                            <button class="btn btn-secondary me-1" style="width: 49%;" id="btn-weapon-attack"
                                disabled="disabled">Attack</button>
                        @else
                            <button class="btn btn-danger me-1" style="width: 49%;"
                                id="btn-weapon-attack">Attack</button>
                        @endif

                        @if ($team->weapon_level == 3)
                            <button class="btn btn-secondary" style="width: 49%;" disabled="disabled"
                                id="btn-upgrade">Upgrade Weapon</button>
                        @else
                    ...
                    <div class="team-hp">
                        ...
                        <div class="progress" style="background: rgba(0,0,0,0.35)">
                            ...
                            <div class="progress-bar" role="progressbar" style="width: {{ $hp_amount }}%;"
                                id="team-hp-bar"></div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="equipment-crafting" tabindex="-1" role="dialog" aria-labelledby="equipmentCrafting"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal"
                        id="btn-confirm-crafting">Crafting</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="equipment-use" tabindex="-1" role="dialog" aria-labelledby="equipmentUse"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="weapon-upgrade" tabindex="-1" role="dialog" aria-labelledby="weaponUpgrade"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal"
                        id="btn-confirm-upgrade">Upgrade</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="reminder-modal" tabindex="-1" role="dialog" aria-labelledby="reminderModal"
        aria-hidden="true">
    ...
    <div class="modal fade" id="winner-modal" tabindex="-1" role="dialog" aria-labelledby="winnerModal"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document" style="min-width: 800px;">
            <div class="modal-content">
                <div class="modal-body">
    ...
    <div class="modal fade" id="konfirmasi-gift" tabindex="-1" role="dialog" aria-labelledby="weaponUpgrade"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal" id="gift_kirim"
                        onclick="gift()">Ya</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data.equipment_requirement, function(index, value) {
                        $('#modal-equipment-requirement-content').append("<div>" + value
                            .nama_material + "&nbsp;&nbsp;&nbsp;x" + value.jumlah_material +
                            "</div>");
                    });
                ...
                success: function(data) {
                    if (data.status) {
                        $('#histories-list').append(
                            "<tr><td><div class='history-detail'><b>[ATTACK]</b> " + data.message +
                            "</div></td></tr>");
                        bringToBottom();
                        $('#atk').show();
                    } else {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.crafting_result) {
                        ...
                        $('#histories-list').append(
                            "<tr><td><div class='history-detail'><b>[CRAFT]</b> " + data.message +
                            "</div></td></tr>");
                        bringToBottom();
                    } else {
                        $('#result-modal').modal('show');
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.use_result) {
                        ...
                        $('#histories-list').append(
                            "<tr><td><div class='history-detail'><b>[USE]</b> " + data.message +
                            "</div></td></tr>");
                        bringToBottom();
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.status) {
                        ...
                        $('#histories-list').append(
                            "<tr><td><div class='history-detail'><b>[UPGRADE]</b> " + data.message +
                            "</div></td></tr>");
                        bringToBottom();
                    } else {
                        $('#result-modal').modal('show');
        ...
        $(document).on("click", ".stop-video", function() {
            ...
            $('#video-reminder').attr('src',
                'https://www.youtube.com/embed/Ngq0omaP8Xg?start=28&autoplay=1&mute=1');
        });
